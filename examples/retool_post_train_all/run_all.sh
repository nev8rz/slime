...
# 5. Qwen2.5-3B-Instruct OPD from the 8B ReTool RL teacher
...
RUN_SFT=${RUN_SFT:-1}
RUN_8B_SFT_CLEAN_DIST=${RUN_8B_SFT_CLEAN_DIST:-1}
RUN_RL=${RUN_RL:-1}
RUN_4B_SFT=${RUN_4B_SFT:-1}
RUN_OPD=${RUN_OPD:-1}
...
if [ "${RUN_8B_SFT_CLEAN_DIST}" = "1" ]; then
